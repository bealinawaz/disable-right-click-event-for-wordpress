...
//    echo "<pre>";print_r($_POST);echo "</pre>";
    if (isset($_POST['amm_drcfw_submit_btn']) && isset($_POST['amm_drcfw_show_msg'])) {
        if (update_option('amm_drcfw_show_msg', sanitize_text_field($_POST['amm_drcfw_show_msg']))) {
            $flag = 1;
        } else {
            $flag = -1;
        }
    ...
    <div class="wrap">
        ...
        <div style="margin:15px 0px; float: right;"> 
            <span>Other WordPress Plugins: </span><a href="https://github.com/bealinawaz" target="_blank" title="Ali Nawaz Wordpress Plugins"><b>Check Here</b></a> | <span>Developed By: </span><a href="http://bealinawaz.com" target="_blank" title="Ali Nawaz"><b>Ali Nawaz</b></a>
        </div>
